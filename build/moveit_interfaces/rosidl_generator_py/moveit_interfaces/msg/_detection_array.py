    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'moveit_interfaces.msg.DetectionArray')
            logger.debug(
            ...
            from moveit_interfaces.msg import Detection
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        'detections': 'sequence<moveit_interfaces/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['moveit_interfaces', 'msg'], 'Detection')),  # noqa: E501
    )
