...
static const _MultiBoxPosition_type_support_symbol_names_t _MultiBoxPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_interfaces, msg, MultiBoxPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_interfaces, msg, MultiBoxPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_interfaces, msg, MultiBoxPosition)() {
  return &::moveit_interfaces::msg::rosidl_typesupport_c::MultiBoxPosition_message_type_support_handle;
}
